...
## 🛠 **Tech Stack**
[![Tech Stack](https://skillicons.dev/icons?i=nodejs,js,html,bootstrap,vite,webpack,electron,express,react,mongodb,git,regex,redis,redux,mysql,netlify,workers,wordpress,cloudflare,vercel,nginx,gcp,firebase,vue,vscode,linux,vim,jquery,devto,selenium,sequelize,tailwind,kubernetes,laravel,figma,py,opencv,postgres,ps,php,postman,prometheus,raspberrypi&theme=light&perline=10)](https://skillicons.dev)
