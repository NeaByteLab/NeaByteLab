...
source: 'https://en.wikipedia.org/wiki/Elementary_algebra'
description: 'The basic form of algebra taught first, covering variables, expressions, and solving equations with real numbers.'
