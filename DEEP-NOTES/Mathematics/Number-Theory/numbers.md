...
description: 'The abstract objects used to count, measure, and label, organized into nested systems from naturals to complex.'
tags: ['mathematics', 'number-theory', 'number-systems', 'foundations']
---
...
flowchart TB
  ...
  Integers --> Rationals["rational numbers"]
  Rationals --> Reals["real numbers"]
  Reals --> Complex["complex numbers"]
```
