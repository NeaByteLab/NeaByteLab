...
source: 'https://en.wikipedia.org/wiki/Mathematical_physics'
description: 'The development of rigorous mathematical methods to formulate and solve the problems of physics.'
tags: ['mathematics', 'applied-mathematics', 'physics', 'differential-equations']
---
...
```mermaid
flowchart TB
  Physics[Physical theory] --> Formulate[Formulate mathematically]
  Formulate --> Structure[Identify structure]
  Structure --> Solve[Prove or solve rigorously]
  Solve --> Predict[Sharper predictions]
  Structure --> NewMath[New mathematics]
```
