...
source: 'https://en.wikipedia.org/wiki/Complex_geometry'
description: 'The study of spaces modeled on complex numbers, where complex structure makes geometry unusually rigid and rich.'
tags: ['mathematics', 'geometry-topology', 'complex-numbers', 'manifolds']
---
...
```mermaid
flowchart TB
  CN[Complex Numbers] --> CM[Complex Manifold]
  CM --> HOL["Holomorphic changes"]
  HOL --> RIG[Rigidity]
  RIG --> KAH[Kahler Manifolds]
  RIG --> ALG[Projective Varieties]
```
